...
namespace Epros.Tests
{
    public class OnboardingTenantTests
    {
        ...
        public async Task ObterContextoSessao_Deve_Retornar_Contexto_Completo()
        {
            ...
            var endereco = new Epros.Modules.GestaoClientes.Domain.ValueObjects.Endereco("Rua", "12", null, "Centro", "12345678", "Cianorte", "PR");
            var empresa1 = new Epros.Modules.GestaoClientes.Domain.Entities.Empresa("Empresa 1 SA", "Emp 1", "12345678901234", null, null, null, null, RegimeTributario.SimplesNacional, RegimeApuracao.Cumulativo, null, null, null, null, null, null, null, null, null, null, endereco, "tenant-1", "system");
            var empresa2 = new Epros.Modules.GestaoClientes.Domain.Entities.Empresa("Empresa 2 SA", "Emp 2", "98765432109876", null, null, null, null, RegimeTributario.SimplesNacional, RegimeApuracao.Cumulativo, null, null, null, null, null, null, null, null, null, null, endereco, "tenant-1", "system");
