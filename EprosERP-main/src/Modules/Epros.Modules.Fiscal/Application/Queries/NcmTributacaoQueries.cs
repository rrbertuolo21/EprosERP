...
namespace Epros.Modules.Fiscal.Application.Queries
{
    ...
    public class ObterNcmTributacaoPorIdQueryHandler : IRequestHandler<ObterNcmTributacaoPorIdQuery, CommandResult>
    {
        ...
        public async Task<CommandResult> Handle(ObterNcmTributacaoPorIdQuery request, CancellationToken cancellationToken)
        {
            ...
            var dto = new
            {
                n.Id, n.TributarioGrupoId, n.CodigoBeneficioFiscalId, n.CodRegra, n.Descricao,
                n.CfopNotaConsumidor, n.CfopNotaFiscal, n.CfopNotaFiscalInterestadual, n.Origem,
                n.CsosnNotaConsumidor, n.CstIcmsNotaConsumidor, n.CsosnNotaFiscal,
                n.CstIcmsNotaFiscalInterna, n.CstIcmsNotaFiscalInterstadual,
                n.CstPis, n.CstCofins, n.ValorUnitFixoPis, n.ValorUnitFixoCofins, n.ValorAliquotaPis, n.ValorAliquotaCofins,
                n.CstPisCofinsEntrada, n.CstIpiSaida, n.CstIpiEntrada, n.ValorAliquotaIpi, n.ValorPercentualReducacaoBcIpi,
                n.TipoReducaoIpi, n.DestinoReducaoIpi, n.IpiEmbutido, n.EnquadramentoIpi,
                n.CodigoValorFiscalIcmsInterna, n.CodigoValorFiscalcmsInterstadual,
                n.ValorAliquotaIcmsInterna, n.ValorPercentualReducacaoBcIcmsInterna, n.TipoReducaoIcmsInterna, n.DestinoReducaoIcmsInterna,
                n.ValorAliquotaIcmsInterstadual, n.ValorPercentualReducacaoBcIcmsInterstadual, n.TipoReducaoIcmsInterstadual, n.DestinoReducaoIcmsInterstadual,
                n.CodigoBeneficioFiscalIcms, n.MotivoDesoneracaoIcms, n.InformacoesComplementares, n.InformacoesAdicionaisAoFisco,
                n.CstIbsCbsNfe, n.CClassTribNfe, n.CstIbsCbsNfce, n.CClassTribNfce,
