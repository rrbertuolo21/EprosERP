...
{
    public record CriarTipoOperacaoFiscalCommand(
    ...
    public class CriarTipoOperacaoFiscalCommandValidator : AbstractValidator<CriarTipoOperacaoFiscalCommand>
    {
        public CriarTipoOperacaoFiscalCommandValidator()
        {
