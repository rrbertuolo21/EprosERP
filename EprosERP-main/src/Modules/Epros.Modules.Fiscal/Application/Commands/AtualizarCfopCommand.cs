...
{
    public record AtualizarCfopCommand(
        Guid Id,
        string Descricao,
    ...
    public class AtualizarCfopCommandValidator : AbstractValidator<AtualizarCfopCommand>
    {
        public AtualizarCfopCommandValidator()
        {
            RuleFor(c => c.Id)
                .NotEmpty().WithMessage("O ID do CFOP é obrigatório.");
