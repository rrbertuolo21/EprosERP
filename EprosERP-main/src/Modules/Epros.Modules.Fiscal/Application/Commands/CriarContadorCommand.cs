...
{
    public record CriarContadorCommand(
        string? RazaoSocial,
        string? NomeContador,
        string? Cpf,
        string? Cnpj,
    ...
    public class CriarContadorCommandValidator : AbstractValidator<CriarContadorCommand>
    {
        public CriarContadorCommandValidator()
        {
