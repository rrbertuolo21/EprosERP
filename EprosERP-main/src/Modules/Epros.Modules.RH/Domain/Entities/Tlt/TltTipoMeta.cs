...
{
    /// <summary>Entidade portada da EF (submodulo RH-TLT, tabela rh_tlt_tipo_meta). Fidelidade campo a campo.</summary>
    public partial class TltTipoMeta : EntidadeSaaSBase
    {
        ...
        public void Validar()
        {
            var contract = new Contract<TltTipoMeta>().Requires();
