...
namespace Epros.Modules.Imobiliaria.Infrastructure.Data
{
    ...
    /// </summary>
    public class ContextImobiliariaDesignTimeFactory : IDesignTimeDbContextFactory<ContextImobiliaria>
    {
        public ContextImobiliaria CreateDbContext(string[] args)
        {
            ...
            return new ContextImobiliaria(options, new DesignTenantProvider(), new DesignCurrentUser());
        }
