...
namespace Epros.Modules.Estoque.Domain.Entities
{
    ...
    public class ProdutoFichaEstoqueSaida : EntidadeSaaSBase
    {
        ...
        /// <summary>Local/armazém quando aplicável (WMS) — EF §15.5. FK Guid sem navegação (módulo WMS ausente).</summary>
        ...
        public ProdutoFichaEstoqueSaida(Guid empresaId, Guid produtoId, Guid fatoGeradorEstoqueId, Guid produtoFichaEstoqueEntradaId, decimal quantidadeMovimentada, decimal valorUnitario, decimal valorCustoMedio, string tenantId, string criadoPor, Guid? localId = null)
