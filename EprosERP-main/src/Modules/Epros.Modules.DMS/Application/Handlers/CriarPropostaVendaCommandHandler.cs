...
{
    public class CriarPropostaVendaCommandHandler : ICommandHandler<CriarPropostaVendaCommand>
    {
        private readonly ContextDMS _context;
        private readonly ITenantProvider _tenantProvider;
        private readonly ICurrentUser _currentUser;

        public CriarPropostaVendaCommandHandler(
            ContextDMS context,
        ...
        public async Task<CommandResult> Handle(CriarPropostaVendaCommand request, CancellationToken cancellationToken)
        {
            var tenantId = _tenantProvider.GetTenantId();
            var usuario = _currentUser.GetUserId() ?? "system";

            var entidade = new PropostaVenda(
            ...
            _context.PropostasVenda.Add(entidade);
