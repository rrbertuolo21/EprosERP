...
{
    public class CriarReservaVeiculoCommandHandler : ICommandHandler<CriarReservaVeiculoCommand>
    {
        private readonly ContextDMS _context;
        private readonly ITenantProvider _tenantProvider;
        private readonly ICurrentUser _currentUser;

        public CriarReservaVeiculoCommandHandler(
            ContextDMS context,
        ...
        public async Task<CommandResult> Handle(CriarReservaVeiculoCommand request, CancellationToken cancellationToken)
        {
            var tenantId = _tenantProvider.GetTenantId();
            var usuario = _currentUser.GetUserId() ?? "system";

            var entidade = new ReservaVeiculo(
                request.EstoqueVeiculoId,
            ...
            _context.ReservasVeiculo.Add(entidade);
