...
{
    public class CriarTestDriveCommandHandler : ICommandHandler<CriarTestDriveCommand>
    {
        private readonly ContextDMS _context;
        private readonly ITenantProvider _tenantProvider;
        private readonly ICurrentUser _currentUser;

        public CriarTestDriveCommandHandler(
            ContextDMS context,
        ...
        public async Task<CommandResult> Handle(CriarTestDriveCommand request, CancellationToken cancellationToken)
        {
            var tenantId = _tenantProvider.GetTenantId();
            var usuario = _currentUser.GetUserId() ?? "system";

            var entidade = new TestDrive(
                request.OportunidadeId,
                request.VeiculoDemonstracaoId,
                request.Inicio,
                request.Fim,
                tenantId,
                usuario);
            ...
            _context.TestDrives.Add(entidade);
