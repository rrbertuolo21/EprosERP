...
{
    /// <summary>Entidade portada da EF (submodulo RH-PLN, tabela rh_pln_historico). Fidelidade campo a campo.</summary>
    public partial class PlnHistorico : EntidadeSaaSBase
    {
        ...
        protected PlnHistorico() { } // EF Core
        ...
        public void Validar()
        {
            var contract = new Contract<PlnHistorico>().Requires();
