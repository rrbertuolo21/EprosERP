...
namespace Epros.Modules.RH.Domain.Entities
{
    ...
    public partial class RecFonteCandidato : EntidadeSaaSBase
    {
        ...
        protected RecFonteCandidato() { } // EF Core

        public RecFonteCandidato(
            string nome,
            string? descricao,
            bool ativo,
        ...
        public void Validar()
        {
            var contract = new Contract<RecFonteCandidato>().Requires();
