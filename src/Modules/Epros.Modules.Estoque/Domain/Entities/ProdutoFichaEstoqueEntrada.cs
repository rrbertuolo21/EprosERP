...
namespace Epros.Modules.Estoque.Domain.Entities
{
    ...
    public class ProdutoFichaEstoqueEntrada : EntidadeSaaSBase
    {
        ...
        /// <summary>Local/armazém quando aplicável (WMS) — EF §15.4. FK Guid sem navegação (módulo WMS ausente).</summary>
        public Guid? LocalId { get; private set; }
        /// <summary>Lote quando informado — EF §15.4.</summary>
        public string? Lote { get; private set; }
        /// <summary>Data de validade quando informada — EF §15.4.</summary>
        ...
        public ProdutoFichaEstoqueEntrada(Guid empresaId, Guid produtoId, Guid fatoGeradorEstoqueId, ETipoEstoque tipoEstoque, decimal quantidadeMovimentada, decimal valorUnitario, string tenantId, string criadoPor, Guid? localId = null, string? lote = null, DateTime? dataValidade = null)
