    ...
    public class ContextFiscal : ContextBase
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<EventoDocumentoFiscal>(entity =>
            {
                ...
                // Caminhos de arquivo do comprovante de cancelamento — REG-CANC-018/019 (varchar(500)).
                entity.Property(e => e.PdfCaminho).HasMaxLength(500);
                entity.Property(e => e.XmlCaminho).HasMaxLength(500);
            });
