...
namespace Epros.Modules.Financeiro.Migrations
{
    ...
    [Migration("20260803130100_AddRegrasContabContratosArrend")]
    partial class AddRegrasContabContratosArrend
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Epros.Modules.Financeiro.Domain.Entities.OrcamentoComercial", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("p_k_orcamentos_comerciais");

                    b.HasIndex("SyncId")
                        .IsUnique()
                        .HasDatabaseName("ix__orcamento_comercial_sync_id");

                    b.HasIndex("TenantId")
                        .HasDatabaseName("ix__orcamento_comercial_tenant_id");

                    b.HasIndex("TenantId", "Codigo")
                        .HasDatabaseName("ix_orcamento_comercial_tenant_codigo");

                    b.HasIndex("TenantId", "StatusPedido")
                        .HasDatabaseName("ix_orcamento_comercial_tenant_status");

                    b.ToTable("orcamentos_comerciais", "financas");
                });

            modelBuilder.Entity("Epros.Modules.Financeiro.Domain.Entities.OrcamentoComercialItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid>("OrcamentoComercialId")
                        .HasColumnType("uuid")
                        .HasColumnName("orcamento_comercial_id");
                    ...
                    b.HasKey("Id")
                        .HasName("p_k_orcamento_comercial_itens");

                    b.HasIndex("OrcamentoComercialId")
                        .HasDatabaseName("ix_orcamento_comercial_item_cabecalho");

                    b.HasIndex("SyncId")
                        .IsUnique()
                        .HasDatabaseName("ix__orcamento_comercial_item_sync_id");

                    b.HasIndex("TenantId")
                        .HasDatabaseName("ix__orcamento_comercial_item_tenant_id");

                    b.ToTable("orcamento_comercial_itens", "financas");
                });

            modelBuilder.Entity("Epros.Modules.Financeiro.Domain.Entities.OrcamentoComercialItem", b =>
                {
                    b.HasOne("Epros.Modules.Financeiro.Domain.Entities.OrcamentoComercial", "OrcamentoComercial")
                        .WithMany("Itens")
                        .HasForeignKey("OrcamentoComercialId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("f_k_orcamento_comercial_itens_orcamentos_comerciais_orcamento_c~");

                    b.Navigation("OrcamentoComercial");
                });
