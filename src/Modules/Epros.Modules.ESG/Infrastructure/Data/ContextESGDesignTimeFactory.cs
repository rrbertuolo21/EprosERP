...
namespace Epros.Modules.ESG.Infrastructure.Data
{
    ...
    /// </summary>
    public class ContextESGDesignTimeFactory : IDesignTimeDbContextFactory<ContextESG>
    {
        public ContextESG CreateDbContext(string[] args)
        {
            ...
            return new ContextESG(options, new DesignTenantProvider(), new DesignCurrentUser());
        }
