    ...
    public class PessoaJuridica : EntidadeSaaSBase
    {
            ...
            : base(tenantId, criadoPor)
        {
            AddNotifications(new Contract<PessoaJuridica>()
                ...
                .HasMaxLen(razaoSocial, 60, nameof(RazaoSocial), "O campo RazaoSocial deve ter no máximo 60 caracteres [Origem: PessoaJuridica]")
                .HasMaxLen(nomeFantasia ?? string.Empty, 60, nameof(NomeFantasia), "O campo NomeFantasia deve ter no máximo 60 caracteres [Origem: PessoaJuridica]")
