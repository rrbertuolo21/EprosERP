...
namespace Epros.Modules.Projetos.Infrastructure.Data
{
    ...
    /// </summary>
    public class ContextProjetosDesignTimeFactory : IDesignTimeDbContextFactory<ContextProjetos>
    {
        public ContextProjetos CreateDbContext(string[] args)
        {
            ...
            return new ContextProjetos(options, new DesignTenantProvider(), new DesignCurrentUser());
        }
