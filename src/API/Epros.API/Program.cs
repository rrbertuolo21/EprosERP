...
try
{
    ...
    // AUTENTICAÇÃO
    // Esquema nativo do EprosERP (EprosToken): valida os tokens estruturados emitidos pelo login
    // (jwt-token-basico-/jwt-token-completo-) e materializa o ClaimsPrincipal autenticado.
