...
{
    public class VendaEmitenteEndereco : Notifiable<Notification>
    {
        public VendaEmitenteEndereco() { }
        public VendaEmitenteEndereco(Estado uf, string logradouro, string numero, string complemento, string bairro, int codMunicipioIbge, string nomeMunicipio, string cep, int codPais = 1058, string nomePais = "BRASIL")
        {
            Uf = uf;
        ...
        public void Validar()
        {
            ...
            .Requires()
            .IsBetween((NomeMunicipio ?? "").Length, 2, 60, "NomeMunicipio", "Municipio do endereço do emitente, deve conter entre 2 e 60 caractes")

            .Requires()
            .IsTrue((Cep ?? "").Length == 8, "Cep", "CEP do endereço do emitente, deve conter 8 caractes")

            .Requires()
            .IsBetween(CodPais.ToString().Length, 1, 4, "Cep", "Código do Pais do endereço do emitente, deve conter entre 1 e 4 caractes")

            .Requires()
            .IsBetween((NomePais ?? "").Length, 2, 60, "NomePais", "Nome do Pais do endereço do emitente, deve conter entre 2 e 60 caractes")
