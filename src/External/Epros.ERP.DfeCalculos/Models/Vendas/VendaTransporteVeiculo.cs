...
{
    public class VendaTransporteVeiculo : Notifiable<Notification>
    {
        public VendaTransporteVeiculo() { }
        public VendaTransporteVeiculo(string placa, string uf, string rntc)
        {
            Placa = placa;
        ...
        public void Validar()
        {
            ...
            .Requires()
            .IsBetween((Placa ?? "").Length, 1, 8, "Placa", "Placa do veículo do transporte de conter entre 1 e 8 caracteres")
            .IsLowerOrEqualsThan(20, (Rntc ?? "").Length, "Rntc", "RNTC do ceículo do reboque, pode conter no max 20 caracteres")
            );
