...
{
    public enum ECodigoSituacaoOperacaoSimplesNacional
    {
    ...
    public enum ECodigoSituacaoOperacaoSimplesNacionalConsumidor
    {
        [Description("102 - Tributada pelo Simples Nacional sem permissão de crédito")]
        Csosn102 = 102,
        [Description("103 - Isenção do ICMS no Simples Nacional para faixa de receita bruta")]
    ...
    public enum ECodigoSituacaoOperacaoSimplesNacionalMEI
    {
        [Description("102 - Tributada pelo Simples Nacional sem permissão de crédito")]
        Csosn102 = 102,
        [Description("103 - Isenção do ICMS no Simples Nacional para faixa de receita bruta")]
